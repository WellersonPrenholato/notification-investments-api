# DESENVOLVER WEB SCRAPING PARA O SITE https://investidor10.com.br/fiis/mxrf11/
...
def get_fii_quote(fii_id:str):
    ...
    url = f'https://investidor10.com.br/fiis/{fii_id}/'
    response = requests.get(url)
    print(response)
    soup = BeautifulSoup(response.text, 'html.parser')

    quote_element = []
    for item in soup.find_all('span', attrs={'class': 'indicator-value'}):
